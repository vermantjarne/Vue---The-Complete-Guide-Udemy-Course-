...
export default {
	// As seen before, components and props remain unchanged
  components: {
    UserItem,
  },
  props: ['users'],
	emits: ['list-projects'],
	setup(props) {
		// The various different parts that belong together logically are placed together logically
    ...
    watch(enteredSearchTerm, (val) => {
      ...
      enteredSearchTerm.value = val;
		...
		const displayedUsers = computed(() => {
			// Since computed properties are also refs, we use .value to access it
			if (!sorting.value) {
