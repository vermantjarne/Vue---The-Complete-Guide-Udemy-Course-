...
export default {
  ...
  setup(props) {
		...
		// Since the useSearch hook returns an object, it is destructured as an object
		const {
			enteredSearchTerm,
			availableItems,
			updateSearch,
		...
		// Despite sorting only being used in this component, it is being outsourced to a custom hook
		const {
			displayedUsers,
			sorting,
			sort,
		...
		// The code below is fully replaced by the hook
